...
<div class="details">
                    <div class="details_operation clearfix">
                        <div class="bui_select">
                            <input type="button" value="添&nbsp;&nbsp;加" class="add tab-btn compileBule" onclick="addPro()">
                        </div>
                        <div class="fr listPro-List">
                            <div class="text">
                                <span>商品价格：</span>
                                <div class="bui_select">
                                    <select id="" class="listPro-select" onchange="change(this.value)">
                                    	<option>-请选择-</option>
                            ...
                            <div class="text">
                                <span>搜索</span>
                                <input type="text" value="" class="listPro-search"  id="search" onkeypress="search()" >
                            </div>
                        </div>
                    </div>
                    <!--表格-->
                            ...
                            <tr>
								...
								<td>
					             ...
					             <td>
					             	...
					             	<input type="button" value="添加文字水印" onclick="doImg('<?php echo $row['id'];?>','waterText')" class="tab-btn"/>
					             	
					             	<br/>
					             		<input type="button" value="添加图片水印" onclick="doImg('<?php echo $row['id'];?>','waterPic')" class="tab-btn"/>
					             </td>       
