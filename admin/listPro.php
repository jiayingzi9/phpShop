	...
	<div class="details">
		<div class="details_operation clearfix">
			<div class="bui_select">
				<input type="button" value="添&nbsp;&nbsp;加" class="add tab-btn compileBule"
					onclick="addPro()" >
			</div>
			<div class="fr listPro-List">
				...
				<div class="text">
					<span>搜索</span> <input type="text" value="" class="listPro-search"
		...
		<table class="table" cellspacing="0" cellpadding="0">
			...
			<tbody>
					...
					<td align="center"><input type="button" value="详情" class="tab-btn compileBule"
						onclick="showDetail(<?php echo $row['id'];?>,'<?php echo $row['pName'];?>')"><input
						type="button" value="修改" class="btn modification"
						onclick="editPro(<?php echo $row['id'];?>)"><input type="button"
						value="删除" class="btn del" onclick="delPro(<?php echo $row['id'];?>)">
