...
<div class="details">
                    <div class="details_operation clearfix">
                        <div class="bui_select">
                            <input type="button" value="添&nbsp;&nbsp;加" class="add tab-btn compileBule"  onclick="addCate()">
                        </div>
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php  foreach($rows as $row):?>
                            <tr>
                                ...
                                <td align="center"><input type="button" value="修改" class="btn modification" onclick="editCate(<?php echo $row['id'];?>)"><input type="button" value="删除" class="btn del"  onclick="delCate(<?php echo $row['id'];?>)"></td>
                            </tr>
                            <?php endforeach;?>
                            <?php if($row>$pageSize):?>
                            <tr>
